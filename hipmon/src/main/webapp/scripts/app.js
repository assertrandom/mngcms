...
var hipmonApp = angular.module('hipmonApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'hipmonAppUtils', 'pascalprecht.translate', 'truncate']);
