...
var mngcmsApp = angular.module('mngcmsApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'mngcmsAppUtils', 'pascalprecht.translate', 'truncate']);
